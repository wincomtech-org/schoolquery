...
elseif ($rec == 'insert') {
    ...
    $sql = "INSERT INTO " . $dou->table('download') . " (id, cat_id, title, defined, content, image, download_link, size ,keywords, add_time, description)" . " VALUES (NULL, '$_POST[cat_id]', '$_POST[title]', '$_POST[defined]', '$_POST[content]', '$file', '$_POST[download_link]', '$_POST[size]', '$_POST[keywords]', '$add_time', '$_POST[description]')";
    $dou->query($sql);
