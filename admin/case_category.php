...
elseif ($rec == 'add') {
    ...
    // CSRF防御令牌生成
    $smarty->assign('token', $firewall->set_token('case_category_add'));
...
elseif ($rec == 'insert') {
    ...
    // CSRF防御令牌验证
    $firewall->check_token($_POST['token'], 'case_category_add');
...
elseif ($rec == 'edit') {
    ...
    // CSRF防御令牌生成
    $smarty->assign('token', $firewall->set_token('case_category_edit'));
...
elseif ($rec == 'update') {
    ...
    // CSRF防御令牌验证
    $firewall->check_token($_POST['token'], 'case_category_edit');
