...
// define('__DS__', DIRECTORY_SEPARATOR);//路径分隔符
// define('__PS__', PATH_SEPARATOR);//目录分隔符
...
// set_include_path(
//     '.'.__PS__.
//     ROOT_PATH.'/data'.__PS__.
//     ROOT_PATH.'/include'.__PS__.
//     get_include_path()
// );
...
// 实例化类
$dou = new Action($dbhost, $dbuser, $dbpass, $dbname, $prefix, DOU_CHARSET);    // action集成common，common集成DBMysql，此句实例化数据库
$check = new Check();
